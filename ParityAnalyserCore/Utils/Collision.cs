...
namespace ParityAnalyserCore
{
	internal static class Collision
	{
        ...
        public static bool SwingPathIntersects(Vector2 position, float startAngle, float endAngle, Vector2 bombPosition, bool debug = false, BaseNote bombForDebug = null)
        {
            ...
            if (debug)
            {
				DebugRenderer.RenderLine(position.ToVector3(), boundaryA.ToVector3(), new Vector3(0, 0, 1), new Vector3(0, 0, 1), 0.02f, sync: bombForDebug);
				DebugRenderer.RenderLine(position.ToVector3(), boundaryB.ToVector3(), new Vector3(1, 0, 0), new Vector3(1, 0, 0), sync: bombForDebug);
        ...
        public static bool SwingPathIntersects(Vector2 position, float startAngle, float endAngle, OrientedRect hitbox, bool debug = false, BaseNote bombForDebug = null)
        {
			...
			if (debug)
			{
				DebugRenderer.RenderLine(position.ToVector3(), boundaryA.ToVector3(), Color.blue, Color.blue, 0.02f, sync: bombForDebug);
				DebugRenderer.RenderLine(position.ToVector3(), boundaryB.ToVector3(), Color.red, Color.red, sync: bombForDebug);
